...
ggplot(df_melt, aes(x = Step, y = Probability, colour = Kernel)) +
  ...
  labs(title = "Convergencia de las Probabilidades Estimadas",
       x = "Pasos", y = "Probabilidad estimada de 1s en la diagonal") +
  theme_minimal()
...
f.  Con los datos el primer inciso, ahora usen las distribuciones (i) gamma (ii) log-normal\
...
ggplot(samples, aes(x=num_sample, y=theta_value))+
  geom_line() +
  facet_grid(~corrida) +
  theme_minimal()
