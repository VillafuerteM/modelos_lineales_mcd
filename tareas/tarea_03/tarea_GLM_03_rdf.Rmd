...
ggplot(plt_df_p6_result) +
  ...
  geom_line(aes(x=x_mcmc, y = fcn_P6_result), colour = "red")
...
9. La sucesión de Fibonacci 1, 1, 2, 3, 5, 8, 13, . . . es descrita por la recurrencia $f_n = f_{n−1} + f_{n−2}$,para n ≥ 3 con $f_1 = f_2 = 1$

a. Mostrar que el número de sucesiones binarias de longitud m sin 1’s adyaentes es fm+2
b. Sea pk,m el número de buenas sucesiones de longitud m con exactamente k 1’s. Mostrar
que
pk,m =

m − k + 1
...

, k = 0, 1, . . . , ceiling(m/2)
c. Sea µm el número esperados de 1’s en una buena sucesión de longitud m bajo la distribución uniforme. Encontrar µm para m = 10, 100, 1000.
